...
export declare class MiddlewaresModule {
    ...
    static setupMiddlewares(app: Application): Promise<void>;
    static setupMiddlewareConfig(config: MiddlewareConfiguration, module: string, app: Application): Promise<void>;
    static setupRouteMiddleware(route: ControllerMetadata & {
        method: RequestMethod;
    }, config: MiddlewareConfiguration, module: string, app: Application): Promise<void>;
