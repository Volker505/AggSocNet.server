...
export declare class Injector {
    ...
    resolveSingleParam<T>(wrapper: InstanceWrapper<T>, param: Metatype<any> | string | symbol, module: Module, context: Module[]): Promise<any>;
    resolveComponentInstance<T>(module: Module, name: any, wrapper: InstanceWrapper<T>, context: Module[]): Promise<any>;
    scanForComponent(components: Map<string, any>, name: any, module: Module, {metatype}: {
        metatype: any;
    }, context?: Module[]): any;
    scanForComponentInExports(components: Map<string, any>, name: any, module: Module, metatype: any, context?: Module[]): Promise<any>;
    scanForComponentInScopes(context: Module[], name: any, metatype: any): any;
    scanForComponentInScope(context: Module, name: any, metatype: any): any;
    scanForComponentInRelatedModules(module: Module, name: any, context: Module[]): Promise<any>;
    resolveFactoryInstance(currentMetatype: any, factoryResult: any): Promise<any>;
